...
namespace MoreMountains.CorgiEngine
{
	...
	public class Health : MonoBehaviour
	{
        ...
        IEnumerator ClearEndlessStage() {
            yield return new WaitForEndOfFrame();
            LevelManager.Instance.scrollSpeed = LevelManager.Instance.originalScrollSpeed;
