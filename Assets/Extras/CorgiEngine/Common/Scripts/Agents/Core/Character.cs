	...
	{		
		...
		protected virtual void Update()
		{
            if (myRenderer.isVisible) {
			    EveryFrame();
                gameObject.GetComponent<CorgiController>().enabled = true;
            } else {
		...
		public virtual void UnFreeze()
		{
            ...
            if (_controller.gameObject.GetComponent<CharacterHandleWeapon>()) {
                _controller.gameObject.GetComponent<CharacterHandleWeapon>().AbilityPermitted = true;
            }
            if (LevelManager.Instance.game != "endless") {
                _controller.gameObject.GetComponent<CharacterHorizontalMovement>().enabled = true;
                _controller.gameObject.GetComponent<CharacterJump>().enabled = true;
            }
