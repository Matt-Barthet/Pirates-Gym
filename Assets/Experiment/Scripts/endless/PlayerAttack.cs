...
namespace MoreMountains.CorgiEngine {
    [AddComponentMenu("Corgi Engine/Weapons/Special Player Attack")]
    /// <summary>
    /// A basic melee weapon class, that will activate a "hurt zone" when the weapon is used
    /// </summary>
    public class PlayerAttack : Weapon {
        ...
        protected virtual IEnumerator MeleeWeaponAttack() {
            ...
            StartCoroutine(ReleaseAttack(TimeBetweenUses));
        }

        protected virtual IEnumerator ReleaseAttack(float t) {
